/*
header comment with author, description, etc
*/
...
RenderWeirdGradient(win32_offscreen_buffer Buffer, int BlueOffset, int GreenOffset)
{
    ...
    int Width = Buffer.Width; // dot is PBV
...
WinMain(HINSTANCE Instance,
        ...
        int       ShowCode)
{
    //uint8 BigMem[2 * 1024 * 1024] = {}; // Stack overflow!

    WNDCLASS WindowClass = {}; // initialize WindowClass to zero
